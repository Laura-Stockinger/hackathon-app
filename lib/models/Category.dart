...
class Category extends amplify_core.Model {
  ...
  const Category._internal({required this.id, name, createdAt, updatedAt}): _name = name, _createdAt = createdAt, _updatedAt = updatedAt;
  
  factory Category({String? id, String? name}) {
